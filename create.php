...
<body style="padding: 5px; display: flex; gap: 100px; justify-content:center;">
    <form method="POST">
        <label for="turma">
            <h2>Adicionar turma:</h2>
        </label><br>
        <input type="text" name="nome" placeholder="Nome da Turma" style="color: black; width: 100%;"><br>
        <input type="text" name="serie" placeholder="Série da Turma" style="color: black; width: 100%;"><br>
    ...
    <form method="POST">
        ...
        <input type="text" name="nome" placeholder="Nome do Professor" style="color: black; width: 100%;"><br>
        <input type="email" name="email" placeholder="Email do Professor" style="color: black; width: 100%;"><br>
        <input type="text" name="fk_turma" placeholder="Turma (ID)" style="color: black; width: 100%;"><br>
        <select name="materia" class="form-select" multiple aria-label="Multiple select example" style="width: 100%;">
    ...
    <form method="POST">
        ...
        <input type="text" name="descricao" placeholder="Descrição" style="color: black; width: 100%;"><br>
        <input type="text" name="fk_professor" placeholder="Professor (ID)" style="color: black; width: 100%;"><br>
        <input type="text" name="fk_turma" placeholder="Turma (ID)" style="color: black; width: 100%;"><br>
        <div class="d-grid gap-2">
